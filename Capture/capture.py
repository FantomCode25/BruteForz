...
from speechtotext import VoskRecognizer  # Import the VoskRecognizer class
import requests  # Import requests to fetch the image from the URL
...
def add():
    ...
    Accepts a username and a photo URL via a POST request.
    """
    ...
    # Get the photo URL from the form data
